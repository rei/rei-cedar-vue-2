riot.tag2('cdr-card-docs-code-toggle', '<div class="code-toggle--control checkbox toggle-show-hide text-xs-right" data-theme="light-20"> <input type="checkbox" value="" id="{elementId}" data-toggle="collapse" data-target="{targetId}"> <label for="{elementId}">View code</label> </div> <div class="collapse code-toggle--document" id="{targetId}" data-theme="light-20"> <pre>\n        <yield from="codeblock">\n        </pre> </div>', '', '', function(opts) {
...
// vim: syntax=JSX
riot.tag2('cdr-video-modal', '<div class="modal" tabindex="-1" keyup="{}" role="dialog" aria-labelledby="videoModal" aria-hidden="true"> <span class="sr-only">Begin dialog</span> <div class="modal__content"> <div class="text-right"> <button id="{opts.dismisstrigger}" class="close icon icon-rei-close img-circle" aria-label="Close"><span class="sr-only sr-only-focusable">Close</span></button> </div> <div class="modal__content--inner"> <div class="embed-responsive embed-responsive-16by9"> <yield></yield> </div> </div> </div> <button class="modal__video--end--dialog sr-only sr-only-focusable">End dialog</button> </div>', 'cdr-video-modal .icon.icon-rei-close.img-circle,[riot-tag="cdr-video-modal"] .icon.icon-rei-close.img-circle,[data-is="cdr-video-modal"] .icon.icon-rei-close.img-circle{background:rgba(0,0,0,0.5);color:#fff;padding:2rem;margin:1.6rem;float:none}@media screen and (max-width:768px){ cdr-video-modal .icon.icon-rei-close.img-circle,[riot-tag="cdr-video-modal"] .icon.icon-rei-close.img-circle,[data-is="cdr-video-modal"] .icon.icon-rei-close.img-circle{position:absolute;top:0;right:0;bottom:auto;left:auto;z-index:1}} cdr-video-modal .modal,[riot-tag="cdr-video-modal"] .modal,[data-is="cdr-video-modal"] .modal{opacity:0;transition:opacity .15s linear} cdr-video-modal .modal .modal__content,[riot-tag="cdr-video-modal"] .modal .modal__content,[data-is="cdr-video-modal"] .modal .modal__content{transition:transform .3s ease-out;transform:translate(0, -25%)}@media screen and (max-width:768px){ cdr-video-modal .modal .modal__content,[riot-tag="cdr-video-modal"] .modal .modal__content,[data-is="cdr-video-modal"] .modal .modal__content{position:absolute;top:0;bottom:0;left:0;right:0}} cdr-video-modal .modal.show.in,[riot-tag="cdr-video-modal"] .modal.show.in,[data-is="cdr-video-modal"] .modal.show.in{opacity:1} cdr-video-modal .modal.show.in .modal__content,[riot-tag="cdr-video-modal"] .modal.show.in .modal__content,[data-is="cdr-video-modal"] .modal.show.in .modal__content{transform:translate(0, 0)} cdr-video-modal .modal__content--inner,[riot-tag="cdr-video-modal"] .modal__content--inner,[data-is="cdr-video-modal"] .modal__content--inner{max-width:90rem;margin:0 auto}@media screen and (max-width:768px){ cdr-video-modal .modal__content--inner,[riot-tag="cdr-video-modal"] .modal__content--inner,[data-is="cdr-video-modal"] .modal__content--inner{width:100%;position:absolute;top:50%;right:auto;bottom:auto;left:50%;text-align:center;transform:translate(-50%, -50%)}} cdr-video-modal .modal__video--end--dialog,[riot-tag="cdr-video-modal"] .modal__video--end--dialog,[data-is="cdr-video-modal"] .modal__video--end--dialog{background-color:transparent;color:#fff}', '', function(opts) {
