...
riot.tag2('cdr-tile-event-aggregator', '<section class="tile"> <div class="hidden-xs media-frame ratio-3-4 portrait center"> <img riot-src="{opts.imgPath}" alt="{opts.imgPathAlt}"> </div> <div class="group group-display-fixed event_wrapper"> <div class="event__date text-uppercase"> <div class="h2 event__title">{opts.dateDayOfWeek}</div> <div class="text-muted">{opts.dateMonthAndDayOfMonth}</div> </div> <div class="col-xs-8 col-sm-7"> <div class="event__content"> <h4 class="event__title">{opts.title}</h4> <div class="location text-muted">{opts.location}</div> </div> </div> </div> </section>', 'cdr-tile-event-aggregator .event__date,[data-is="cdr-tile-event-aggregator"] .event__date{padding:1.2rem} cdr-tile-event-aggregator .event__title,[data-is="cdr-tile-event-aggregator"] .event__title{font-family:inherit} cdr-tile-event-aggregator .event__title.h2,[data-is="cdr-tile-event-aggregator"] .event__title.h2{margin-bottom:0;line-height:1} cdr-tile-event-aggregator .event__content,[data-is="cdr-tile-event-aggregator"] .event__content{border-left:1px solid #ccc;padding-left:1.2rem;padding-right:1.2rem;margin:1.2rem 0;flex:0 1 auto} cdr-tile-event-aggregator .location,[data-is="cdr-tile-event-aggregator"] .location{line-height:1}', '', function(opts) {
});
