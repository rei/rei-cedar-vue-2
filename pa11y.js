...
var urls = [
    'http://localhost:9002/layouts/grid/',
    'http://localhost:9002/elements/typography/',
    'http://localhost:9002/elements/buttons/',
    'http://localhost:9002/elements/links/',
    'http://localhost:9002/elements/inputs/'
];
