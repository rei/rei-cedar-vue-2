riot.tag2('cdr-card-docs', '<article class="card vertical-push-lg"> <section class="card-block-xs-open-default card-block-top" data-theme="medium-10"> <h3 class="card-doc-heading">{opts.exampleTitle}</h3> </section> <section class="card-block-xs-open-default"> <yield from="example-description"></yield> </section> <section if="{opts.exampleStyle == null}" class="card-block-xs-open-default cedar-example" data-example-id="{opts.elementId}"> <yield from="example"></yield> </section> <section data-theme="{opts.exampleTheme}" if="{opts.exampleStyle}" class="{opts.exampleStyle + \' cedar-example\'}" data-example-id="{opts.elementId}"> <yield from="example"></yield> </section> <div class="code-toggle--control checkbox toggle-expand-collapse text-xs-right" data-theme="medium-10"> <input type="checkbox" value="" id="{\'checkbox-\' + opts.elementId}" data-toggle="collapse" data-target="{\'#\' + opts.elementId}"> <label for="{\'checkbox-\' + opts.elementId}">View code</label> </div> <div class="collapse code-toggle--document" id="{opts.elementId}" data-theme="medium-10"> <yield from="codeblock"></yield> </div> </article>', '', '', function(opts) {
});
...
riot.tag2('cdr-modal-video', '<div> <button type="button" class="btn btn-play" onclick="{showModal}"> <span class="icon icon-rei-play-small" aria-hidden="true"></span>{opts.buttonText}</button> <aside if="{opened}" class="cdr-modal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="dialog1Title"> <span id="dialog1Title" class="sr-only">{\'Begin dialog for\' + opts.videoTitle}</span> <div class="cdr-modal__content"> <button onclick="{hideModal}" type="button" class="btn-contrast btn-icon btn-bare" aria-label="Close"> <span class="icon icon-rei-close-small" aria-hidden="true"></span> <span class="sr-only">Close button</span> </button> <section class="cdr-modal__content--inner"> <div class="embed-responsive embed-responsive-16by9"> <iframe title="{opts.videoTitle}" width="900" height="506" riot-src="https://www.youtube.com/embed/{opts.videoId}" frameborder="0" allowfullscreen></iframe> </div> </section> </div> <span class="sr-only">End dialog</span> </aside> </div>', '', '', function(opts) {
...
riot.tag2('cdr-well-docs', '<div class="well vertical-push-lg"> <div class="group group-display-fixed"> <div class="col-xs-12 col-sm-8"> <h2 id="{opts.exampleId}">{opts.exampleTitle}</h2> </div> <div class="col-xs-12 col-sm-4"> <div class="code-toggle--control checkbox toggle-expand-collapse text-sm-right"> <input type="checkbox" value="" id="{\'checkbox-\' + opts.elementId}" data-toggle="collapse" data-target="{\'#\' + opts.elementId}"> <label for="{\'checkbox-\' + opts.elementId}">View code</label> </div> </div> </div> <div class="collapse code-toggle--document vertical-push" id="{opts.elementId}"> <yield from="codeblock"></yield> </div> <section> <yield from="example-description"></yield> </section> <section if="{opts.exampleStyle == null}" class="cedar-example" data-example-id="{opts.elementId}"> <yield from="example"></yield> </section> <section data-theme="{opts.exampleTheme}" if="{opts.exampleStyle}" class="{opts.exampleStyle + \' cedar-example\'}" data-example-id="{opts.elementId}"> <yield from="example"></yield> </section> </div>', '', '', function(opts) {
});
