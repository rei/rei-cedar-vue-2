...
export default {
  ...
  computed: {
    ...
    ratingSrText() {
      return ` average rating of ${this.rounded} out of 5 stars`;
    },
    countSrText() {
      return this.count !== null ? `${this.count} reviews with an` : '';
    },
  },
  render() {
    ...
    return (
      ...
      >
        ...
        <span class={this.style['cdr-rating__caption-sr']}>
          {this.href ? 'view the ' : ''}{this.countSrText}{this.ratingSrText}
        </span>
      </Component>
    );
  },
