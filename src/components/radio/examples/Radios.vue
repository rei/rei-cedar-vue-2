<template>
  <div>
    ...
    <cdr-radio name="example" value="a4" v-model="ex1" disabled>A4 (disabled)</cdr-radio>
    <p>Group A Picked: {{ex1}}</p>

    <cdr-radio name="example2" value="b1" v-model="ex2">B1</cdr-radio>
    <cdr-radio name="example2" value="b2" v-model="ex2">B2</cdr-radio>
    <p>Group B Picked: {{ex2}}</p>

    <cdr-radio name="example3" value="c1" v-model="ex3" disabled>C1 (selected + disabled)</cdr-radio>
    <cdr-radio name="example3" value="c2" v-model="ex3">C2</cdr-radio>
