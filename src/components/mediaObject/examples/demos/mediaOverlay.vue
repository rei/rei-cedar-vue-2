<template>
  ...
  <cdr-row cols="1" justify="center" align="stretch">
      <cdr-col span="6">
        <cdr-media-object
        media-figure="http://placehold.it/350x150/212121/444444"
      ...
      <cdr-col span="4">
        <cdr-media-object
          media-figure="http://placehold.it/350x350/212121/444444"
          media-img-shape="circle responsive"
          level="3"
          media-title="Stretched circle image shape overlay"
      ...
      <cdr-col span="4">
        <cdr-media-object
          ...
          level="3"
          media-title="rounded image shape overlay"
