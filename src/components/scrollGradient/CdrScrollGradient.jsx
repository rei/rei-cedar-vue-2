...
export default {
  ...
  methods: {
      ...
      if (this.vertical) {
        ...
        if (contentHeight > containerHeight) {
          ...
          this.overflowBottom = (scrollY + 1) < (contentHeight - containerHeight);
            console.log({scrollY, ot: this.overflowTop, ob: this.overflowBottom, contentHeight, containerHeight})
        } else {
      ...
      if (this.horizontal) {
        ...
        if (contentWidth > containerWidth) {
          ...
          this.overflowRight = (scrollX + 1) < (contentWidth - containerWidth);
            console.log({scrollX, ot: this.overflowLeft, ob: this.overflowRight, contentWidth, containerWidth})
        } else {
    ...
    createGradientStyle(direction) {
      const gradient = `linear-gradient(to ${direction}, rgba(255, 255, 255, 0), ${this.backgroundColor})`;
      return {
        background: gradient,
      };
    }
    ...
    return (
      <div class={this.style[this.baseClass]}  ref="cdrScrollGradientContainer">
        <div class={clsx(
          ...
          this.overflowLeft && this.horizontal  ? this.style['cdr-scroll-gradient--overlay-active'] : '',
        )}
        ...
        <div class={clsx(
          ...
          this.overflowTop && this.vertical ? this.style['cdr-scroll-gradient--overlay-active'] : '',
        )}
          style={this.gradientTopStyle}
        ></div>


        <div class={clsx(this.style['cdr-scroll-gradient--content'], this.styleClass)} ref="cdrScrollGradientContent">
          { this.$slots.default }
        </div>
        ...
        <div class={clsx(
          ...
          this.overflowRight && this.horizontal ? this.style['cdr-scroll-gradient--overlay-active'] : '',
        )}
        ...
        <div class={clsx(
          ...
          this.overflowBottom && this.vertical ? this.style['cdr-scroll-gradient--overlay-active'] : '',
        )}
