  ...
  <div>
    <div data-backstop="display">
      ...
      <cdr-text
        ...
        :tag="`h${n}`"
        modifier="display-600 display-700@sm display-800@md display-900@lg"
