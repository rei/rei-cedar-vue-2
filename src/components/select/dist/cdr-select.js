...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dc273c70_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_node_modules_vue_theme_loader_index_js_ref_1_1_cdrSelect_vue__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted() {
    ...
    if (this.multiple) {
      const opts = Object(__WEBPACK_IMPORTED_MODULE_0__node_modules_lodash__["toArray"])(this.$refs.select.options);
      opts.forEach(opt => {
        const o = opt;
  ...
  methods: {
    onInput(e) {
      if (this.multiple) {
        const optArr = Object(__WEBPACK_IMPORTED_MODULE_0__node_modules_lodash__["toArray"])(e.target.options);
