...
|:-----------------------------------------------------------------------|:-------|:--------|
| size                                                                    | string | medium    |
| Modifies the icon size; values can target responsive breakpoints. Breakpoint values are: breakpoint--xs, breakpoint--sm, breakpoint--md, and breakpoint--lg. Examples: { 'small' | 'medium' | 'large' | 'large@sm' }  |        |         |
