...
$(function () {
  ...
  QUnit.module('tooltip', {
    beforeEach: function () {
      ...
      // Because this (tooltip) module is instantiated twice (once for this test and once for the popover test as a dependency)
      // we have to call noConflict twice to clear out the reference to $.fn.tooltip on the global scope. This allows
      // the tooltip noConflict test to run properly.
