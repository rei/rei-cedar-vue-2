<template>
  <div>
    ...
    <div data-backstop="image-standard">
      ...
      <cdr-img ratio="16-9" alt="cdr-img example" src="http://placehold.it/200x200"></cdr-img>
      <cdr-img alt="cdr-img example" src="http://placehold.it/350x150"></cdr-img>
      <cdr-img alt="cdr-img example" src="http://placehold.it/150x350"></cdr-img>
    </div>
  </div>
</template>
