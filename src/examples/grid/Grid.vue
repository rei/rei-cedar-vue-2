<template>
  <div>
    ...
    <div data-backstop="grid-basic">
      ...
      <div class="cdr-grid _grid7">
        <div class="cdr-col">
          <div class="grid-demo">7</div>
        </div>
        <div class="cdr-col">
          <div class="grid-demo">7</div>
        </div>
      ...
      <div class="cdr-grid _grid9">
        <div class="cdr-col">
          <div class="grid-demo">9</div>
        </div>
        <div class="cdr-col">
          <div class="grid-demo">9</div>
        </div>
      ...
      <div class="cdr-grid _grid10">
        <div class="cdr-col">
          <div class="grid-demo">10</div>
        </div>
        <div class="cdr-col">
          <div class="grid-demo">10</div>
        </div>
    ...
    <h4>cdr-grid (auto sizes)</h4>
    <div data-backstop="grid-auto">
      <div class="cdr-grid">
        <div class="cdr-col">
    ...
    <div data-backstop="grid-noGutter">
    ...
    <div data-backstop="grid-noWrap">
      <div class="cdr-grid _grid3 -gridNoWrap">
          <div class="cdr-col">
            <div class="grid-demo">3</div>
          </div>
    ...
    <div data-backstop="grid-gridSpaceBetween">
    ...
    <div data-backstop="grid-SpaceAround">
    ...
    <div data-backstop="grid-col-mix">
      <div class="cdr-grid _grid3">
        <div class="cdr-col">
          <div class="grid-demo">3</div>
        </div>
    ...
    <div data-backstop="col-right-grid-right">
    ...
    <h4>cdr-grid responsive grid classes</h4>
    <h5>Medium breakpoint</h5>
    <p>_grid2 _grid4-md</p>
    <div data-backstop="grid-md-sized">
    ...
    <p>auto _grid6-md</p>
    <div data-backstop="grid-md-auto">
    ...
    <p>-gridNoGutter-md</p>
    <div data-backstop="grid-md-noGutter">
      <div class="cdr-grid _grid6 -gridNoGutter-md">
        <div class="cdr-col">
          <div class="grid-demo">6</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridCenter-md</p>
    <div data-backstop="grid-md-center">
      <div class="cdr-grid _grid6 -gridCenter-md">
        <div class="cdr-col">
          <div class="grid-demo">6</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridRight-md</p>
    <div data-backstop="grid-md-right">
      <div class="cdr-grid _grid6 -gridRight-md">
        <div class="cdr-col">
          <div class="grid-demo">6</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridTop-md</p>
    <div data-backstop="grid-md-top">
      <div class="cdr-grid _grid3 -gridTop-md">
        <div class="cdr-col">
          <div class="grid-demo">3</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridMiddle-md</p>
    <div data-backstop="grid-md-middle">
      <div class="cdr-grid _grid3 -gridMiddle-md">
        <div class="cdr-col">
          <div class="grid-demo">3</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridBottom-md</p>
    <div data-backstop="grid-md-bottom">
      <div class="cdr-grid _grid3 -gridBottom-md">
        <div class="cdr-col">
          <div class="grid-demo">3</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridSpaceBetween-md</p>
    <div data-backstop="grid-md-spaceBetween">
      <div class="cdr-grid _grid6 -gridSpaceBetween-md">
        <div class="cdr-col">
          <div class="grid-demo">6</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridSpaceAround-md</p>
    <div data-backstop="grid-md-spaceAround">
      <div class="cdr-grid _grid6 -gridSpaceAround-md">
        <div class="cdr-col">
          <div class="grid-demo">6</div>
        </div>
        <div class="cdr-col">
    ...
    <p>-gridColumn-md</p>
    <div data-backstop="grid-md-column">
      <div class="cdr-grid _grid3 -gridColumn-md">
        <div class="cdr-col">
          <div class="grid-demo">3</div>
        </div>
        <div class="cdr-col">
    ...
    <div data-backstop="grid-lg-sized">
    ...
    <p>auto _grid3-lg</p>
    <div data-backstop="grid-lg-auto">
    ...
    <p>-gridNoGutter-lg</p>
    <div data-backstop="grid-lg-noGutter">
    ...
    <p>-gridCenter-lg</p>
    <div data-backstop="grid-lg-center">
    ...
    <p>-gridRight-lg</p>
    <div data-backstop="grid-lg-right">
    ...
    <p>-gridMiddle-lg</p>
    <div data-backstop="grid-lg-middle">
    ...
    <p>-gridBottom-lg</p>
    <div data-backstop="grid-lg-bottom">
    ...
    <div data-backstop="grid-lg-spaceBetween">
    ...
    <div data-backstop="grid-lg-spaceAround">
    ...
    <p>-gridColumn-lg</p>
    <div data-backstop="grid-lg-column">
    ...
    <div data-backstop="grid-xl-sized">
    ...
    <p>auto _grid3-xl</p>
    <div data-backstop="grid-xl-auto">
    ...
    <p>-gridNoGutter-xl</p>
    <div data-backstop="grid-xl-noGutter">
    ...
    <p>-gridCenter-xl</p>
    <div data-backstop="grid-xl-center">
    ...
    <p>-gridRight-xl</p>
    <div data-backstop="grid-xl-right">
    ...
    <p>-gridMiddle-xl</p>
    <div data-backstop="grid-xl-middle">
    ...
    <p>-gridBottom-xl</p>
    <div data-backstop="grid-xl-bottom">
    ...
    <div data-backstop="grid-xl-spaceBetween">
    ...
    <div data-backstop="grid-xl-spaceAround">
    ...
    <p>-gridColumn-xl</p>
    <div data-backstop="grid-xl-column">
    ...
    <div data-backstop="grid-xxl-sized">
    ...
    <p>auto _grid3-xxl</p>
    <div data-backstop="grid-xxl-auto">
    ...
    <div data-backstop="grid-xxl-noGutter">
    ...
    <p>-gridCenter-xxl</p>
    <div data-backstop="grid-xxl-center">
    ...
    <p>-gridRight-xxl</p>
    <div data-backstop="grid-xxl-right">
    ...
    <p>-gridTop-xxl</p>
    <div data-backstop="grid-xxl-top">
    ...
    <p>-gridMiddle-xxl</p>
    <div data-backstop="grid-xxl-middle">
    ...
    <p>-gridBottom-xxl</p>
    <div data-backstop="grid-xxl-bottom">
    ...
    <div data-backstop="grid-xxl-spaceBetween">
    ...
    <div data-backstop="grid-xxl-SpaceAround">
    ...
    <p>-gridColumn-xxl</p>
    <div data-backstop="grid-xxl-column">
    ...
    <div data-backstop="grid-full-responsive">
    ...
    <div data-backstop="grid-justify-responsive">
    ...
    <div data-backstop="grid-alignment-responsive">
    ...
    <div data-backstop="col-md-sized">
      <div class="cdr-grid">
        <div class="cdr-col _col3-md">
          <div class="grid-demo">auto > 3</div>
        </div>
        <div class="cdr-col">
          <div class="grid-demo"></div>
        </div>
    ...
    <div data-backstop="grid-md-offset">
      <div class="cdr-grid">
        <div class="cdr-col -colRight1-md">
          <div class="grid-demo">-colRight1-md</div>
        </div>
        <div class="cdr-col -colLeft1-md">
          <div class="grid-demo">-colLeft1-md</div>
        </div>
      </div>
    </div>
    ...
    <div data-backstop="col-md-alignment">
      <div class="cdr-grid">
        ...
        <div class="cdr-col -colMiddle-md">
          <div class="grid-demo">-mid</div>
        </div>
        <div class="cdr-col -colBottom-md">
          <div class="grid-demo">-bot</div>
        </div>
        <div class="cdr-col">
          <div class="grid-demo">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque odit illum quos praesentium eveniet, odio, commodi, quam quia nesciunt harum alias officia, mollitia sequi vel tempora rem eos exercitationem incidunt!</div>
        </div>
      </div>
    </div>
    ...
    <div data-backstop="col-lg-offset">
      <div class="cdr-grid">
        <div class="cdr-col -colRight1-lg">
          <div class="grid-demo">-colRight1-lg</div>
        </div>
        <div class="cdr-col -colLeft1-lg">
          <div class="grid-demo">-colLeft1-lg</div>
        </div>
      </div>
    </div>
    <p>-colTop -colMiddle -colBottom</p>
    ...
    <div data-backstop="col-xl-offset">
      <div class="cdr-grid">
        <div class="cdr-col -colRight1-xl">
          <div class="grid-demo">-colRight1-xl</div>
        </div>
        <div class="cdr-col -colLeft1-xl">
          <div class="grid-demo">-colLeft1-xl</div>
        </div>
      </div>
    </div>
    <p>-colTop -colMiddle -colBottom</p>
    ...
    <div data-backstop="col-xxl-offset">
      <div class="cdr-grid">
        <div class="cdr-col -colRight1-xxl">
          <div class="grid-demo">-colRight1-xxl</div>
        </div>
        <div class="cdr-col -colLeft1-xxl">
          <div class="grid-demo">-colLeft1-xxl</div>
        </div>
      </div>
    </div>
    <p>-colTop -colMiddle -colBottom</p>
