...
var cedar = (function () {
  ...
  Object.defineProperty(this, "$style", { value: {} });
    ...
    var CdrLink = normalizeComponent_1(
   ...
   */
  function validateProp$1(propValue, validArr, responsive = true) {
  ...
  var size = {
    ...
    props: {
      ...
      size: {
        type: String,
        default: 'medium',
        validator: value => validateProp$1(
          value,
          ['small', 'medium', 'large'],
        ),
      },
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-b2e12510_0", { source: "\n@import 'cssdir/settings/_index.pcss';\n@import './styles/vars/CdrButton.vars.pcss';\n@import './styles/CdrButton.pcss';\n", map: {"version":3,"sources":["/Users/dtrimil/Code/rei-cedar/src/components/button/CdrButton.vue"],"names":[],"mappings":";AAoHA,qCAAA;AACA,2CAAA;AACA,iCAAA","file":"CdrButton.vue","sourcesContent":["<template>\n  <component\n    :is=\"tag\"\n    :class=\"[\n      modifierClass,\n      buttonSizeClass,\n      fullWidthClass,\n      iconClass,\n    ]\"\n    :type=\"tag === 'button' ? type : null\"\n    @click=\"onClick\"\n  >\n    <!-- @slot for icon -->\n    <slot name=\"icon\" />\n    <!-- @slot innerHTML on the inside of the button component -->\n    <slot />\n  </component>\n</template>\n\n<script>\nimport modifier from 'mixinsdir/modifier';\nimport size from 'mixinsdir/size';\n\n/**\n * Cedar 2 component for button\n *\n * CdrButton will render either a button, or an anchor that looks like a button.\n * As such, the decision to use CdrButton vs CdrAnchor should be made based on what\n * you need the rendered element to look like.\n *\n * @author [REI Software Engineering](https://rei.github.io/rei-cedar/)\n */\nexport default {\n  name: 'CdrButton',\n  mixins: [modifier, size],\n  props: {\n    /**\n     * Controls render as button or anchor. {button, a}\n     */\n    tag: {\n      type: String,\n      default: 'button',\n      validator: value => (['button', 'a'].indexOf(value) >= 0) || false,\n    },\n    /**\n     * Sets the button type. {button, submit, reset}\n     */\n    type: {\n      type: String,\n      default: 'button',\n      validator: value => (['button', 'submit', 'reset'].indexOf(value) >= 0) || false,\n    },\n    /**\n     * Adds custom click actions.\n     */\n    onClick: {\n      type: Function,\n      default: () => () => null,\n    },\n    /**\n     * Sets width to be 100%.\n    */\n    fullWidth: {\n      type: Boolean,\n      default: false,\n      validator: value => typeof value === 'boolean',\n    },\n    /**\n     * Renders an icon-only button. Default slot is disabled. Overrides size and responsiveSize props.\n     */\n    iconOnly: {\n      type: Boolean,\n      default: false,\n    },\n    /**\n     * Renders an icon-only button with a light fill color for use on dark backgrounds.\n     * iconOnly must be true.\n     */\n    onDark: {\n      type: Boolean,\n      default: false,\n    },\n  },\n  computed: {\n    baseClass() {\n      return 'cdr-button';\n    },\n    buttonSizeClass() {\n      return !this.iconOnly ? this.sizeClass : null;\n    },\n    iconClass() {\n      const classes = [];\n\n      if (this.$slots.icon && this.$slots.default) {\n        /* only add class for buttons with text + icon */\n        classes.push(this.modifyClassName(this.baseClass, 'has-icon'));\n      }\n\n      if (this.iconOnly) {\n        classes.push(this.modifyClassName(this.baseClass, 'icon-only'));\n\n        if (this.onDark) {\n          classes.push(this.modifyClassName(this.baseClass, 'on-dark'));\n        }\n      }\n      return classes.join(' ');\n    },\n    fullWidthClass() {\n      return this.fullWidth && !this.iconOnly\n        ? this.modifyClassName(this.baseClass, 'full-width') : null;\n    },\n  },\n};\n</script>\n\n<style module>\n  @import 'cssdir/settings/_index.pcss';\n  @import './styles/vars/CdrButton.vars.pcss';\n  @import './styles/CdrButton.pcss';\n</style>\n\n<style>\n  @import '@rei/cdr-icon/dist/cdr-icon.css';\n</style>\n"]}, media: undefined });
  Object.defineProperty(this, "$style", { value: {} })
  ,inject("data-v-b2e12510_1", { source: "\n@import '@rei/cdr-icon/dist/cdr-icon.css';\n", map: {"version":3,"sources":["/Users/dtrimil/Code/rei-cedar/src/components/button/CdrButton.vue"],"names":[],"mappings":";AA0HA,yCAAA","file":"CdrButton.vue","sourcesContent":["<template>\n  <component\n    :is=\"tag\"\n    :class=\"[\n      modifierClass,\n      buttonSizeClass,\n      fullWidthClass,\n      iconClass,\n    ]\"\n    :type=\"tag === 'button' ? type : null\"\n    @click=\"onClick\"\n  >\n    <!-- @slot for icon -->\n    <slot name=\"icon\" />\n    <!-- @slot innerHTML on the inside of the button component -->\n    <slot />\n  </component>\n</template>\n\n<script>\nimport modifier from 'mixinsdir/modifier';\nimport size from 'mixinsdir/size';\n\n/**\n * Cedar 2 component for button\n *\n * CdrButton will render either a button, or an anchor that looks like a button.\n * As such, the decision to use CdrButton vs CdrAnchor should be made based on what\n * you need the rendered element to look like.\n *\n * @author [REI Software Engineering](https://rei.github.io/rei-cedar/)\n */\nexport default {\n  name: 'CdrButton',\n  mixins: [modifier, size],\n  props: {\n    /**\n     * Controls render as button or anchor. {button, a}\n     */\n    tag: {\n      type: String,\n      default: 'button',\n      validator: value => (['button', 'a'].indexOf(value) >= 0) || false,\n    },\n    /**\n     * Sets the button type. {button, submit, reset}\n     */\n    type: {\n      type: String,\n      default: 'button',\n      validator: value => (['button', 'submit', 'reset'].indexOf(value) >= 0) || false,\n    },\n    /**\n     * Adds custom click actions.\n     */\n    onClick: {\n      type: Function,\n      default: () => () => null,\n    },\n    /**\n     * Sets width to be 100%.\n    */\n    fullWidth: {\n      type: Boolean,\n      default: false,\n      validator: value => typeof value === 'boolean',\n    },\n    /**\n     * Renders an icon-only button. Default slot is disabled. Overrides size and responsiveSize props.\n     */\n    iconOnly: {\n      type: Boolean,\n      default: false,\n    },\n    /**\n     * Renders an icon-only button with a light fill color for use on dark backgrounds.\n     * iconOnly must be true.\n     */\n    onDark: {\n      type: Boolean,\n      default: false,\n    },\n  },\n  computed: {\n    baseClass() {\n      return 'cdr-button';\n    },\n    buttonSizeClass() {\n      return !this.iconOnly ? this.sizeClass : null;\n    },\n    iconClass() {\n      const classes = [];\n\n      if (this.$slots.icon && this.$slots.default) {\n        /* only add class for buttons with text + icon */\n        classes.push(this.modifyClassName(this.baseClass, 'has-icon'));\n      }\n\n      if (this.iconOnly) {\n        classes.push(this.modifyClassName(this.baseClass, 'icon-only'));\n\n        if (this.onDark) {\n          classes.push(this.modifyClassName(this.baseClass, 'on-dark'));\n        }\n      }\n      return classes.join(' ');\n    },\n    fullWidthClass() {\n      return this.fullWidth && !this.iconOnly\n        ? this.modifyClassName(this.baseClass, 'full-width') : null;\n    },\n  },\n};\n</script>\n\n<style module>\n  @import 'cssdir/settings/_index.pcss';\n  @import './styles/vars/CdrButton.vars.pcss';\n  @import './styles/CdrButton.pcss';\n</style>\n\n<style>\n  @import '@rei/cdr-icon/dist/cdr-icon.css';\n</style>\n"]}, media: undefined });
    ...
    var CdrButton = normalizeComponent_1(
  ...
  Object.defineProperty(this, "$style", { value: {} });
    ...
    var CdrCta = normalizeComponent_1(
  ...
  __vue_render__$3._withStripped = true;
    ...
    var CdrText = normalizeComponent_1(
  ...
  __vue_render__$5._withStripped = true;
    ...
    const __vue_inject_styles__$5 = function (inject) {
      if (!inject) return
      inject("data-v-2524dc0a_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n/* This should be removed: */\n\n/* having custom styles here provides false positives */\n.button-example {\n  padding: 10px;\n}\n.button-example button,\n.button-example a {\n  margin: 0 10px 5px 0;\n}\n", map: {"version":3,"sources":["/Users/dtrimil/Code/rei-cedar/src/components/button/examples/demo/Default.vue"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2JA,4BAAA;;AAEA,uDAAA;AAEA;EACA,aAAA;AACA;AAEA;;EAEA,oBAAA;AACA","file":"Default.vue","sourcesContent":["<template>\n  <div>\n    <div\n      class=\"button-example\"\n      v-for=\"(section, index) in data\"\n      :key=\"index\"\n    >\n      <cdr-text\n        tag=\"h3\"\n        modifier=\"heading-small\"\n      >\n        {{ section.title }}\n      </cdr-text>\n      <cdr-button\n        v-for=\"(button, index2) in section.buttons\"\n        :key=\"index2\"\n        :size=\"button.size\"\n        :full-width=\"button.fullWidth\"\n        :type=\"button.type\"\n        :disabled=\"button.disabled\"\n        :data-backstop=\"button.backstop ? button.backstop : null\"\n      >\n        {{ button.label }}\n      </cdr-button>\n    </div>\n    <div class=\"button-example\">\n      <cdr-text\n        tag=\"h3\"\n        modifier=\"heading-small\"\n      >\n        Responsive\n      </cdr-text>\n      <cdr-button\n        :on-click=\"log\"\n        :full-width=\"true\"\n        size=\"large@sm\"\n      >\n        Responsive with default\n      </cdr-button>\n    </div>\n    <div class=\"button-example\">\n      <cdr-text\n        tag=\"h3\"\n        modifier=\"heading-small\"\n      >\n        Primary Anchor\n      </cdr-text>\n      <cdr-button\n        tag=\"a\"\n        href=\"https://rei.com\"\n        size=\"large\"\n        data-backstop=\"cdr-button--anchor\"\n      >\n        Link\n      </cdr-button>\n    </div>\n  </div>\n</template>\n\n<script>\n// import Components from 'componentsdir/_index';\nimport { CdrText, CdrButton } from 'componentsdir/_index';\n\nexport default {\n  name: 'Default',\n  components: {\n    CdrText,\n    CdrButton,\n  },\n  data: function data() {\n    return {\n      data: [\n        {\n          title: 'Default sizes',\n          buttons: [\n            {\n              label: 'Large',\n              disabled: false,\n              size: 'large',\n              fullWidth: false,\n              backstop: 'cdr-button--size',\n            },\n            {\n              label: 'Medium',\n              disabled: false,\n              size: 'medium',\n              fullWidth: false,\n            },\n            {\n              label: 'Small',\n              disabled: false,\n              size: 'small',\n              fullWidth: false,\n            },\n          ],\n        },\n        {\n          title: 'Disabled',\n          buttons: [\n            {\n              label: 'Large',\n              disabled: true,\n              size: 'large',\n              fullWidth: false,\n              backstop: 'cdr-button--disabled',\n            },\n            {\n              label: 'Medium',\n              disabled: true,\n              size: 'medium',\n              fullWidth: false,\n            },\n            {\n              label: 'Small',\n              disabled: true,\n              size: 'small',\n              fullWidth: false,\n            },\n          ],\n        },\n        {\n          title: 'Full Width',\n          buttons: [\n            {\n              label: 'Small + full width',\n              disabled: false,\n              size: 'small',\n              fullWidth: true,\n            },\n            {\n              label: 'Medium + full width',\n              disabled: false,\n              size: 'medium',\n              fullWidth: true,\n            },\n            {\n              label: 'Large + full width',\n              disabled: false,\n              size: 'large',\n              fullWidth: true,\n            },\n          ],\n        },\n      ],\n    };\n  },\n  methods: {\n    log() {\n      console.log('clicked'); // eslint-disable-line\n    },\n  },\n};\n</script>\n\n<style>\n/* This should be removed: */\n\n/* having custom styles here provides false positives */\n\n.button-example {\n  padding: 10px;\n}\n\n.button-example button,\n.button-example a {\n  margin: 0 10px 5px 0;\n}\n</style>\n"]}, media: undefined });
  ...
  __vue_render__$6._withStripped = true;
    ...
    const __vue_inject_styles__$6 = function (inject) {
      if (!inject) return
      inject("data-v-36069c30_0", { source: "\n.button-example {\n  padding: 10px;\n}\n", map: {"version":3,"sources":["/Users/dtrimil/Code/rei-cedar/src/components/button/examples/demo/Secondary.vue"],"names":[],"mappings":";AAgHA;EACA,aAAA;AACA","file":"Secondary.vue","sourcesContent":["<template>\n  <div>\n    <div\n      class=\"button-example\"\n      v-for=\"(section, index) in data\"\n      :key=\"index\"\n    >\n      <cdr-text\n        tag=\"h3\"\n        modifier=\"heading-small\"\n      >\n        {{ section.title }}\n      </cdr-text>\n      <cdr-button\n        v-for=\"(button, index2) in section.buttons\"\n        :key=\"index2\"\n        :size=\"button.size\"\n        :full-width=\"button.fullWidth\"\n        :modifier=\"button.modifier\"\n        :type=\"button.type\"\n        :disabled=\"button.disabled\"\n        :data-backstop=\"button.backstop ? button.backstop : null\"\n      >{{ button.label }}</cdr-button>\n    </div>\n    <div class=\"button-example\">\n      <cdr-text\n        tag=\"h3\"\n        modifier=\"heading-small\"\n      >\n        Secondary Anchor\n      </cdr-text>\n      <cdr-button\n        tag=\"a\"\n        href=\"https://rei.com\"\n        size=\"small\"\n        modifier=\"secondary\"\n        data-backstop=\"cdr-button--small secondary anchor\"\n      >Link <span>text in span</span>\n      </cdr-button>\n    </div>\n  </div>\n</template>\n\n<script>\n// import CdrButton from 'componentsdir/button/CdrButton';\n// import CdrText from 'componentsdir/text/CdrText';\n\nimport { CdrButton, CdrText } from 'componentsdir/_index';\n\nexport default {\n  name: 'Secondary',\n  components: {\n    CdrButton,\n    CdrText,\n  },\n  data: function data() {\n    return {\n      data: [\n        {\n          title: 'Secondary',\n          buttons: [\n            {\n              label: 'Large',\n              disabled: false,\n              size: 'large',\n              modifier: 'secondary',\n              backstop: 'cdr-button--secondary',\n            },\n            {\n              label: 'Medium',\n              disabled: false,\n              size: 'medium',\n              modifier: 'secondary',\n            },\n            {\n              label: 'Small',\n              disabled: false,\n              size: 'small',\n              modifier: 'secondary',\n            },\n          ],\n        },\n        {\n          title: 'Secondary Disabled',\n          buttons: [\n            {\n              label: 'Large',\n              disabled: true,\n              size: 'large',\n              modifier: 'secondary',\n            },\n            {\n              label: 'Medium',\n              disabled: true,\n              size: 'medium',\n              modifier: 'secondary',\n            },\n            {\n              label: 'Small',\n              disabled: true,\n              size: 'small',\n              modifier: 'secondary',\n            },\n          ],\n        },\n      ],\n    };\n  },\n};\n</script>\n\n<style>\n  .button-example {\n    padding: 10px;\n  }\n</style>\n"]}, media: undefined });
  ...
  __vue_render__$7._withStripped = true;
    ...
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-0344ea35_0", { source: "\n.button-example {\n  padding: 10px;\n}\n", map: {"version":3,"sources":["/Users/dtrimil/Code/rei-cedar/src/components/button/examples/Buttons.vue"],"names":[],"mappings":";AAgCA;EACA,aAAA;AACA","file":"Buttons.vue","sourcesContent":["<template>\n  <div>\n    <cdr-text\n      tag=\"h2\"\n      modifier=\"heading-small\"\n    >\n      Buttons\n    </cdr-text>\n    <default-buttons />\n    <secondary-buttons />\n    <icon-buttons />\n  </div>\n</template>\n\n<script>\n// import CdrText from 'componentsdir/text/CdrText';\nimport defaultButtons from 'componentsdir/button/examples/demo/Default';\nimport secondaryButtons from 'componentsdir/button/examples/demo/Secondary';\n// import iconButtons from 'componentsdir/button/examples/demo/Icons';\n\nexport default {\n  name: 'Buttons',\n  components: {\n    // CdrText,\n    defaultButtons,\n    secondaryButtons,\n    // iconButtons,\n  },\n};\n</script>\n\n<style>\n  .button-example {\n    padding: 10px;\n  }\n</style>\n"]}, media: undefined });
  ...
  __vue_render__$8._withStripped = true;
    ...
    const __vue_inject_styles__$8 = function (inject) {
      if (!inject) return
      inject("data-v-33da0c8e_0", { source: "\n.button-example {\n  padding: 10px;\n}\n", map: {"version":3,"sources":["/Users/dtrimil/Code/rei-cedar/src/components/cta/examples/Cta.vue"],"names":[],"mappings":";AAoEA;EACA,aAAA;AACA","file":"Cta.vue","sourcesContent":["<template>\n  <div>\n    <cdr-text\n      tag=\"h2\"\n      modifier=\"heading-small\"\n    >\n      CTA\n    </cdr-text>\n    <div class=\"button-example\">\n      <cdr-cta\n        data-backstop=\"cdr-cta--dark\"\n      >\n        Dark\n      </cdr-cta>\n      <cdr-cta\n        href=\"https://rei.com\"\n        cta-style=\"brand\"\n        data-backstop=\"cdr-cta--brand\"\n      >Brand</cdr-cta>\n      <cdr-cta\n        href=\"https://rei.com\"\n        cta-style=\"light\"\n        data-backstop=\"cdr-cta--light\"\n      >Light</cdr-cta>\n      <cdr-cta\n        href=\"https://rei.com\"\n        cta-style=\"sale\"\n        data-backstop=\"cdr-cta--sale\"\n      >Sale</cdr-cta>\n    </div>\n    <div class=\"button-example\">\n      <cdr-cta\n        cta-style=\"dark\"\n        href=\"https://rei.com\"\n        :full-width=\"true\"\n        data-backstop=\"cdr-cta--full-width\"\n      >Full width</cdr-cta>\n    </div>\n    <div\n      class=\"button-example\"\n      style=\"max-width: 300px;\"\n    >\n      <cdr-cta\n        data-backstop=\"cdr-cta--elevated\"\n        href=\"https://rei.com\"\n        cta-style=\"light\"\n        modifier=\"elevated\"\n      >\n        This button has long text. It wraps!\n      </cdr-cta>\n    </div>\n  </div>\n</template>\n\n<script>\n// import Components from 'componentsdir/_index';\nimport { CdrText, CdrCta } from 'componentsdir/_index';\n\nexport default {\n  name: 'Cta',\n  components: {\n    CdrCta,\n    CdrText,\n  },\n};\n</script>\n\n<style>\n  .button-example {\n    padding: 10px;\n  }\n</style>\n"]}, media: undefined });
  ...
  __vue_render__$a._withStripped = true;
    ...
    var visibility = normalizeComponent_1(
  ...
  __vue_render__$b._withStripped = true;
    ...
    var align = normalizeComponent_1(
  ...
  __vue_render__$c._withStripped = true;
    ...
    var inline = normalizeComponent_1(
  ...
  __vue_render__$d._withStripped = true;
    ...
    var inset = normalizeComponent_1(
  ...
  __vue_render__$e._withStripped = true;
    ...
    var stack = normalizeComponent_1(
  ...
  __vue_render__$f._withStripped = true;
    ...
    const __vue_inject_styles__$f = function (inject) {
      if (!inject) return
      inject("data-v-fee8ce06_0", { source: "\n.container-test {\n  background-color: lightblue;\n  padding: 20px;\n  margin-bottom: 20px;\n  line-height: 1;\n}\n", map: {"version":3,"sources":["/Users/dtrimil/Code/rei-cedar/src/components/Utilities/demos/container.vue"],"names":[],"mappings":";AAcA;EACA,2BAAA;EACA,aAAA;EACA,mBAAA;EACA,cAAA;AACA","file":"container.vue","sourcesContent":["<template>\n  <div\n    class=\"cdr-container container-test cdr-text-center\"\n    data-backstop=\"utility-container\"\n  >Container test</div>\n</template>\n\n<script>\nexport default {\n  name: 'ContainerTest',\n};\n</script>\n\n<style>\n.container-test {\n  background-color: lightblue;\n  padding: 20px;\n  margin-bottom: 20px;\n  line-height: 1;\n}\n</style>\n"]}, media: undefined });
